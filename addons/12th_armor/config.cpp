...
class CfgPatches {
  class 12th_armor {
    ...
    weapons[]= {
      ...
      "12th_helm_win_lpl_med",
      "12th_helm_win_nv",
      "12th_helm_win_med_nv",
      "12th_helm_win_1pl_ftl_nv",
      "12th_helm_win_1pl_sl_nv",
      "12th_helm_win_1pl_pl_nv",
      "12th_helm_win_1pl_med_nv",
      "12th_helm_win_2pl_ftl_nv",
      "12th_helm_win_2pl_sl_nv",
      "12th_helm_win_2pl_pl_nv",
      "12th_helm_win_2pl_med_nv",
      "12th_helm_win_hq_ftl_nv",
      "12th_helm_win_hq_sl_nv",
      "12th_helm_win_hq_pl_nv",
      "12th_helm_win_hq_med_nv",
      "12th_helm_win_lpl_ftl_nv",
      "12th_helm_win_lpl_sl_nv",
      "12th_helm_win_lpl_pl_nv",
...
class CfgWeapons {
  ...
  CAP_B(12th_logo,    "[12th][Caps] Cap (12th Logo)")
  ...
  // NOTE:
  // one might be tempted to re-organize all of these
  // into a cleaner set of macro calls but 'brute-forcing' it like this
  // is much simpler to grasp while getting us 80% of
  // the way there in terms of config quality.
  ...
  // NOTE: There is an exact copy of this macro in the custom helmet section.
  // The reason why this macro isn't re-used in either one of the asset is because
  // I want to keep things separate between all things individually customized
  // for 12th members and all things available to everyone.
  // .
  // Makes things easier for anyone re-packaging our stuff.
